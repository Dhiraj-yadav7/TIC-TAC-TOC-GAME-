export default function Scoreboard({ stats, loading, playerX = "Player X", playerO = "Player O" }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center min-w-[65px] sm:min-w-[80px] text-center">
        <span className="text-teal-300 text-[10px] sm:text-xs uppercase tracking-wider font-bold truncate max-w-[100px]" title={`${playerX} (X)`}>
          {playerX} (X)
        </span>
      ...
      <div className="flex flex-col items-center min-w-[65px] sm:min-w-[80px] text-center">
        <span className="text-purple-300 text-[10px] sm:text-xs uppercase tracking-wider font-bold truncate max-w-[100px]" title={`${playerO} (O)`}>
          {playerO} (O)
        </span>
        <span className="text-xl sm:text-2xl font-extrabold text-white mt-0.5">
          {loading ? "..." : oWins}
